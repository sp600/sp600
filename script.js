...
scotchApp.config(['$translateProvider', function($translateProvider) {
	$translateProvider.translations('en', {
	  ...
	  $translateProvider.translations('cn', {
		...
		'DOMESTIC11': '帮助申请各类院校，其中包括：军校，航空航天，艺术，烹饪，时装设计等等。对于特长学生，如体育， 帮助完成整个介绍，推荐及申请进入名校。',
		...
		'TESTIMONIALS3': '我们有在中国和美国生活的不同经历和亲身体验，更了解中国学生和家长的处境和愿望。 流利英文，普通话，广东话， 便于与家长/学生沟通交流。',
		//Colleges Section
		'COLLEGES1': 'Adelphi University',
		'COLLEGES2': 'Barnard College',
		'COLLEGES3': 'Berklee College of Music',

...
scotchApp.config(['$translateProvider', function($translateProvider) {
    ...
    'N_CONTACT': '联系方式',
		...
		// About Our Team
		'Susan': '拥有30多年在中国及美国担任教师的从教经验，不仅了解中美的教育体系，更了解各类学生的需求，为学生们提供高质量，个性化的专业服务。精通中英文，是中国学生/家长与团队专家们沟通交流的桥梁与纽带，帮助协调与解决各类问题。'
		...
		'Aaron': '毕业于纽约大学史顿商学院 (NYU Stern)，并荣获硕士学位。多年兼任纽约大学校友面试官，积累了丰富的经验，对于各类院校的录取有着更深层次的理解，对指导学生申请进入理想大学有着独特的优势。喜欢旅行，健身，棒球，和赛自行车。',

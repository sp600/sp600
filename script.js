...
scotchApp.config(['$translateProvider', function($translateProvider) {
    ...
    'N_CONTACT': 'Contact',
		...
		// Contact Section
		'CONTACT': 'Please fill out the following form, then press submit. Someone from our team will be in touch shortly.',
		// Team Section
		...
		'SERVICES12': 'Regularly visit the students, acting as a legal guardian here in the the U.S. We will also monitor academc performance, as well as any other issues that come up.',
    ...
    'N_CONTACT': '联系方式',
	  	// About Us
		'ABOUT': '我们是毕业于美国著名大学的一群优秀学子，当年的学业和升学都遇到了很大的挑战，但是我们都从艰难困境中成功地走了出来。回首往日我们冲语言障碍，考特殊高中，学特长技能，做有效义工，写大学论文，填助学补助申请，等等。 过关斩将, 踏进名校，再入理想职场。展望前程，辉煌似锦! '
		...
		// Contact Section
		'CONTACT': '请你填写下面资料， 然后按 “Submit" 键递交， 我们会尽快回复你。',
		// Team Section
		...
		// About Our Team
		'Susan': '毕业于中国师范大学，完成了美国大学的教育专业课程。拥有30多年担任中国及美国教师的经验，不仅了解中美的教育体系，更了解各类学生的需求。精通中英文，是中国学生/家长与团队专家们沟通交流的桥梁与纽带，帮助协调与解决各类问题。'
			+ '闲暇时间喜欢演奏乐器，习练太极拳，以及阅读。',
		'Daniel': '毕业于长青藤名校康奈尔大学 (Cornell University)工程学院，现兼任康奈尔大学招生官。出身于教育世家，具有深厚的学术修养与独到的专业见解。能全面把握学生的学校与专业选择，以及职业发展方向，多次创造了低分高就的申请奇迹。热爱运动，擅长长跑和室内攀岩。热衷金融，善于投资理财。',
		'Chris': '毕业于长青藤名校滨州大学 (University of Pennsylvania)物理系，现就读于另一所长青藤名校耶鲁大学 (Yale University)攻读量子物理学博士。对于申请理工院校及专业选择有独到的见解。擅长玩飞碟，经常参加训练与比赛。喜欢亲自下厨烹饪美食。',
		'Aaron': '毕业于纽约大学史顿商学院 (NYU Stern)，并荣获硕士学位。多年兼任纽约大学校友面试官，对于各类院校的录取有着更深层次的理解，对指导学生申请进入理想大学有着独特的优势。能为学生们提供高质量，个性化的专业服务。喜欢旅行，健身，棒球，和赛自行车。',
